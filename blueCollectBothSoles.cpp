...
cout<<"C++ code init"<<endl;
    ...
    while(fgets(buff_Right, sizeof(buff_Right), in1)!=NULL && fgets(buff_Left, sizeof(buff_Left), in2)!=NULL)
    {
        ...
        else if(tmp_Right[1] == '3' && tmp_Left[1] == '3')
        {
            ...
            //Right Sole Pressure Based Color
            ...
            sprintf(message, " %f %f %f %d %f %f %f %f %f %f %d %f %f %f\n", rollAccL, pitchComplementL, altYawLeft, colorL,  accX_Left, accY_Left, accZ_Left, 
                rollAccR, pitchComplementR, altYawRight, colorR,  accX_Right, accY_Right, accZ_Right);
            write(sockfd, message, strlen(message));
            cout<<"LEFT FOOT DATA:: X:"<< accX_Left<< " Y: "<< accY_Left<<" Z: "<< accZ_Left <<endl;
            cout<<"RIGHT FOOT DATA:: X:"<< accX_Right<< " Y: "<< accY_Right<<" Z: "<< accZ_Right <<endl;
            //Bobs code ends here
